...
$(foreach pkg, $1,
	$(ifeq $($(subst -,_,$(pkg))_flavor, meson),
		$(call make-meson-package-rules,$(pkg),$2),
		$(ifeq $($(subst -,_,$(pkg))_flavor, autotools),
			$(call make-autotools-package-rules,$(pkg),$2))))
