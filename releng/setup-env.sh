...
case $host_os in
  ...
  macos|ios|tvos)
    ...
    common_flags+=("-target" "$host_clang_arch-apple-$host_os$apple_os_minver" "-isysroot" "$apple_sdk_path")
...
machine_file=${FRIDA_BUILD}/${FRIDA_ENV_NAME:-frida}-${host_os_arch}.txt
